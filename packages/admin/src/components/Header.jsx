...
export default function () {
  ...
  useEffect(() => {
    ...
    fetch('https://registry.npmjs.org/@raline/vercel/latest')
      .then((resp) => resp.json())
      .then((resp) => {
    ...
    latestVersion ? (
      <div className="upgrade-tips clear-fix" key="upgrade">
        <Trans
          ...
          defaults="New version @raline/vercel@{{version}} published, please upgrade it! Goto <a href='https://raline.js.org/en/advanced/faq.html#server' target='_blank'>FAQ</a> to find How to upgrade it."
          components={{
            a: <a />,
          }}
          values={{
