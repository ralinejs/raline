...
export interface ralineUserListResult {
  /**
   * 用户数据
   *
   * User Data
...
export const UserList = ({
  ...
  mode = 'list',
}: ralineUserListOptions): Promise<ralineUserListResult> => {
