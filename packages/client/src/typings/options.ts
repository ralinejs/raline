import type { ralineProps } from './raline.js';

export interface ralineInitOptions extends Omit<ralineProps, 'path'> {
  /**
   * raline 的初始化挂载器。必须是一个**有效的** CSS 选择器 或 HTML 元素
   *
...
export type ralineAbort = (reason?: any) => void;
