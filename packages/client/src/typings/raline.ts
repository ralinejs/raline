...
export interface ralineProps {
  /**
   * raline 的服务端地址
   *
   * raline server address url
   */
  serverURL: string;
   ...
   * 自定义 raline 语言显示
   *
   * @see [自定义语言](https://raline.js.org/client/i18n.html)
   *
   * Custom display language in raline
   *
   * @see [I18n](https://raline.js.org/en/client/i18n.html)
   */
  locale?: Partial<ralineLocale>;
   ...
   *
   * @more Setting `'auto'` will display darkmode due to device settings. Filling in CSS selector will enable darkmode only when the selector match raline ancestor nodes.
   */
  dark?: string | boolean;
   ...
   * @default true
   */
  search?: ralineSearchOptions | boolean;
   ...
   * 是否在页脚展示版权信息
   *
   * 为了支持 raline，我们强烈建议你开启它
   *
   * Whether show copyright in footer
   *
   * We strongly recommended you to keep it on to support raline
   *
   * @default true
   */
  copyright?: boolean;
